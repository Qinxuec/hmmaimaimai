                                    ...
                                    <div class="form-box accept-box form-box1">
                                        <dl class="head form-group">
                                            <dd>
                                                ...
                                                <router-link v-if="orderinfo.status==1" :to="'/orderItem/'+orderid" class="btn-pay">去付款</router-link>
                                                <!---->
                                            </dd>
                                        </dl>
                                        <dl class="form-group">
                                                ...
                                                <tr>
                                                    <td colspan="7" align="right">
                                                        ...
                                                        <p style="font-size: 22px;">应付总金额：
                                                            <b class="red">￥{{orderinfo.payable_amount+orderinfo.express_fee}}</b>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </tbody>
